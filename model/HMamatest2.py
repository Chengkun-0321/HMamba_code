...
class ModelArgs:
    ...
    learning_rate: float = 0.001  # 新增學習率參數
...
# 輸出為 Concatenate 後的張量，shape 為 (batch, 3)
# ---------------------------
def build_model(args: ModelArgs):
    ...
    print("Model output shape (for debug):", output.shape)
...
def loss_mse(y_true, y_pred):
    """
    自訂 loss 函數，計算 mean、upper 與 lower 分支的 loss，
    此函數內部亦利用 loss_mse_lambda 與 loss_mse_lambda_2。
    """
    # 將 y_pred 轉置後 expand_dims，使其 shape 為 (3, 1, batch)
